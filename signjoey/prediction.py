...
from torchtext_compat import Dataset
...
from metrics import bleu, chrf, rouge, wer_list, mpjpe, fid, mpvpe, mpjae
...
def validate_on_data(
    ...
    with torch.no_grad():
        ...
        if do_recognition:
            ...
            gls_ref = [gls_cln_fn(" ".join(example.gls)) for example in data.examples]
        ...
        if do_translation:
            ...
            txt_ref = [join_char.join(example.txt) for example in data.examples]
    ...
    if output_path is not None:
        if do_recognition:
            ...
            _write_to_file(
                ...
                [example.sequence for example in dev_data.examples],
            ...
            _write_to_file(
                ...
                [example.sequence for example in test_data.examples],
